        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="{{ asset('back/images/faces/riyan.jpeg') }}" alt="profile"/>
            </a>
        ...
        <div class="tab-content" id="setting-content">
          ...
          <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
            ...
            <ul class="chat-list">
              ...
              <li class="list">
                <div class="profile"><img src="{{ asset('back/images/faces/face6.jpg') }}" alt="image"><span class="offline"></span></div>
                <div class="info">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <ul class="icon-data-list">
                    <li>
                      <div class="d-flex">
                        <img src="{{ asset('back/images/faces/face1.jpg') }}" alt="user">
                        <div>
                    ...
                    <li>
                      <div class="d-flex">
                        <img src="{{ asset('back/images/faces/face5.jpg') }}" alt="user">
                        <div>
                    ...
                    <li>
                      <div class="d-flex">
                        <img src="{{ asset('back/images/faces/face4.jpg') }}" alt="user">
                        <div>
